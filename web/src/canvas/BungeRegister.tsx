...
import { BungeBody, FlowDescriptionField, FlowGroundingField, FlowNameField } from "./EdgePopover";
          ...
          {selectedRelation && (
            <div ref={relationEdRef} className="mt-2 pl-6">
              <div className="w-72 rounded-md p-3" style={editorBox}>
                ...
                <FlowGroundingField relation={selectedRelation} onUpdateRelation={onUpdateRelation} />
                <BungeBody
