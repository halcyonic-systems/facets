...
mod tests {
    ...
    fn crossing_flow_without_interface_is_refused_at_operational() {
        ...
        model.environment.sources.push(ExternalEntity {
            info: Info { id: src_id.clone(), level: -1, name: "Feed".to_string(), description: String::new(), grounding: None },
            ty: ExternalEntityType::Source,
            transform: None,
            equivalence: String::new(),
            model: String::new(),
        ...
        model.systems[0].boundary.interfaces.push(Interface {
            info: Info { id: iface_id.clone(), level: 1, name: "Inlet".to_string(), description: String::new(), grounding: None },
            protocol: String::new(),
            ty: InterfaceType::Import,
            exports_to: vec![],
            receives_from: vec![],
    ...
    fn divergent_interface_declaration_is_refused_at_operational() {
        ...
        for (id, name) in [(&drawn, "Drawn"), (&declared, "Declared")] {
            model.environment.sinks.push(ExternalEntity {
                info: Info { id: id.clone(), level: -1, name: name.to_string(), description: String::new(), grounding: None },
                ty: ExternalEntityType::Sink,
                transform: None,
                equivalence: String::new(),
                model: String::new(),
        ...
        model.systems[0].boundary.interfaces.push(Interface {
            info: Info { id: iface_id.clone(), level: 1, name: "Outflow".to_string(), description: String::new(), grounding: None },
            protocol: String::new(),
    ...
    fn unrouted_flow_still_records_the_declaration() {
        ...
        model.environment.sources.push(ExternalEntity {
            info: Info { id: src.clone(), level: -1, name: "In".to_string(), description: String::new(), grounding: None },
            ty: ExternalEntityType::Source,
            transform: None,
            equivalence: String::new(),
            model: String::new(),
