...
mod decomposition_seam {
    ...
    fn a_derived_child_keeps_the_identity_its_parent_is_stamped_with() {
        let mut m = CanvasModel {
            ...
            relations: vec![
                Relation { id: 1, a: 2, b: 4, name: "crude".into(), description: String::new(), grounding: None, usability: None, is_bond: true, kind: Kind::Matter, klir_directed: false, weight: None, amount: None, unit: String::new(), substance: String::new(), ample: false },
                Relation { id: 2, a: 4, b: 1, name: "feed".into(), description: String::new(), grounding: None, usability: None, is_bond: true, kind: Kind::Matter, klir_directed: false, weight: None, amount: None, unit: String::new(), substance: String::new(), ample: false },
                Relation { id: 3, a: 1, b: 5, name: "hot".into(), description: String::new(), grounding: None, usability: None, is_bond: true, kind: Kind::Matter, klir_directed: false, weight: None, amount: None, unit: String::new(), substance: String::new(), ample: false },
                Relation { id: 4, a: 5, b: 3, name: "refined".into(), description: String::new(), grounding: None, usability: None, is_bond: true, kind: Kind::Matter, klir_directed: false, weight: None, amount: None, unit: String::new(), substance: String::new(), ample: false },
            ],
            boundary: Default::default(),
