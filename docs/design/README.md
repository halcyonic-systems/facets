...
- [`epistemic-ordering.md`](epistemic-ordering.md) — the two-axes distinction (proven lens lattice vs Klir's epistemological levels) and the cross-tradition reading that motivates data-first entry ([#309](https://github.com/halcyonic-systems/bert-lenses/issues/309)) and Data mode ([#304](https://github.com/halcyonic-systems/bert-lenses/issues/304)); primary-source grounding lives in the vault.
