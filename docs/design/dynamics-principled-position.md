...
**Status: ADOPTED (2026-07-18, [#86](https://github.com/halcyonic-systems/facets/issues/86)).** This is the repo's position of record on what counts as dynamics. It supersedes the retired "dynamics = the conservation engine" framing (roadmap Arc 4). `language/spec.md` §8 is normatively bound to it; this doc is the single source of truth for the dynamics-record definition.
