...
**Status: RESEARCH** (2026-07-18). Not in-tool, and **untracked**: the curriculum was planned against [#80](https://github.com/halcyonic-systems/facets/issues/80) and #21, and both closed in July 2026 having shipped narrower things — #80 the on-canvas pairing of every lens's edge names with its math (2026-07-20), #21 law comments on tests (2026-07-19). Neither carried this curriculum.
