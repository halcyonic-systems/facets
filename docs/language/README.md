...
**Status: LIVE.** SL v1.0 is specified and shipped (2026-07-18). Implementation is live in the app: write SL in the text pane, compile, and the model renders and is judged like any other. Round-trip goldens pass. The language is under active development; §"Known gaps" in the spec lists what v1.1 owes.
