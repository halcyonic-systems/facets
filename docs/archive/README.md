...
- [`on-the-word-ladder.md`](on-the-word-ladder.md) — **HISTORICAL** — the concordance of the three senses of "ladder/rung/climb". The mode-entry sense is retired ([#90](https://github.com/halcyonic-systems/facets/issues/90)); the doc records the senses that legitimately survive.
