...
//! │ This is the Arc-1 *viewer* (`src/bin/viewer.rs`, `cargo run --bin viewer`). │
//! │ The live front door is now the direct-manipulation CANVAS (`src/main.rs`).  │
//! │ Kept on purpose: this file is the worked                                    │
